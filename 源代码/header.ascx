...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.aspx" class="navbar-brand">房屋房源网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>HouseType/frontlist.aspx">房屋类型</a></li>
                <li><a href="<%=basePath %>House/frontlist.aspx">房源查询</a></li>
               <!--
                <li><a href="<%=basePath %>UserInfo/frontlist.aspx">用户</a></li>-->
                <li><a href="<%=basePath %>Huxing/frontlist.aspx">房源户型</a></li>
                <li><a href="<%=basePath %>Zhuangxiu/frontlist.aspx">装修程度</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Leaveword/frontUserAdd.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布留言</a></li>
                        <li><a href="<%=basePath %>Leaveword/userFrontList.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的留言</a></li>
