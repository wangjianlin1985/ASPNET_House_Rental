...
namespace chengxusheji.Admin
{
    public partial class UserInfoList : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("UserInfoList.aspx?user_name=" + user_name.Text.Trim() + "&&name=" + name.Text.Trim()+ "&&birthDate=" + birthDate.Text.Trim()+ "&&telephone=" + telephone.Text.Trim());
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            sb.Append("<thead><tr><th colSpan='8'>用户记录</th></tr>");
